...
const { fetchCachedCrystalsWithoutClient } = require('../functions/crystals.js')
...
module.exports = {
	...
	async execute(interaction) {
		...
		if (user_id) {
			const playerCrystals = fetchCachedCrystalsWithoutClient()[user_id] || [] //interaction.client.cachedCrystals[user_id] || [];
